...
def plot_and_save_graphs(train_maes, val_maes, train_loss_regs, val_loss_regs, train_loss_classes, val_loss_classes, train_loss_leafs, val_loss_leafs, train_loss_fusions, val_loss_fusions):
...
try:
    ...
    print("\nTraining interrupted by user. Saving graphs with data so far...")
    plot_and_save_graphs(train_maes, val_maes, train_loss_regs, val_loss_regs, train_loss_classes, val_loss_classes, train_loss_leafs, val_loss_leafs, train_loss_fusions, val_loss_fusions)
    print("Graphs saved. Exiting gracefully.")
    exit(0)

# Normal end of training
plot_and_save_graphs(train_maes, val_maes, train_loss_regs, val_loss_regs, train_loss_classes, val_loss_classes, train_loss_leafs, val_loss_leafs, train_loss_fusions, val_loss_fusions)
