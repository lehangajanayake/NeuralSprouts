...
try:
    ...
    plot_and_save(train_maes, val_maes, train_class_accs, val_class_accs, train_reg_losses, val_reg_losses, train_class_losses, val_class_losses, out_path='summary_v3.png')
