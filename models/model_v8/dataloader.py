"""Data loaders for model_v8 training and inference.

These mirror the v4.2 loaders but keep the class names distinct so multiple
variants can coexist within the repo.
"""
...
class PlantDatasetV8(Dataset):
    """Returns RGB, RGBD, and dry-weight targets (regression only)."""
...
class TestPlantDatasetV8(Dataset):
    """Loads RGB + Depth pairs for inference."""
